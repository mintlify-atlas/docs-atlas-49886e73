...
<AccordionGroup>
  ...
  <Accordion title="Latency & jitter">
    ...
    - **Jitter**: Variation in latency measurements, calculated as interquartile range
  ...
  <Accordion title="Network quality score">
    ...
    - **Video Streaming**: Based on download speed and latency
    - **Online Gaming**: Based on latency, jitter, and packet loss
    - **Video Chatting**: Based on upload speed, latency, and jitter
  </Accordion>
